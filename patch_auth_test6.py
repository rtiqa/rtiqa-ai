...
content = content.replace(
    'mockApi.throwable = HttpException(Response.error<Any>(401, ResponseBody.create(okhttp3.MediaType.parse("application/json"), "Unauthorized")))',
...
content = content.replace(
    'mockApi.throwable = HttpException(Response.error<Any>(500, ResponseBody.create(okhttp3.MediaType.parse("application/json"), "Server Error")))',
